...
START_TEST(test_2_n) {
  ...
  ck_assert_int_eq(s21_mult_number(&m2, 0.0, &res), ERROR_INCORRECT_MATRIX);
}
END_TEST
...
START_TEST(test_3_n) {
  ...
  ck_assert_int_eq(s21_mult_number(NULL, 0.0, res), ERROR_INCORRECT_MATRIX);
}
END_TEST
...
START_TEST(test_4) {
  ...
  ck_assert_int_eq(s21_mult_number(&m1, 0.0, NULL), ERROR_INCORRECT_MATRIX);
...
START_TEST(test_1_n_) {
  ...
  ck_assert_int_eq(s21_mult_matrix(&m1, &m2, &res), ERROR_CALCULATE_MATRIX);
...
START_TEST(test_2_n_) {
  ...
  ck_assert_int_eq(s21_mult_matrix(&m1, &m2, &res), ERROR_INCORRECT_MATRIX);
...
START_TEST(test_3_n_) {
  ...
  ck_assert_int_eq(s21_mult_matrix(&m1, NULL, &res), ERROR_INCORRECT_MATRIX);
...
START_TEST(test_4_n_) {
  ...
  ck_assert_int_eq(s21_mult_matrix(&m1, &m2, NULL), ERROR_INCORRECT_MATRIX);
